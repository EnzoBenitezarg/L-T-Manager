      ...
      <div className={styles.grid}>
        <form className={styles.form} onSubmit={handleSave}>
          <Card className={styles.seccion}>
            ...
            <p className={styles.hint}>El rubro cambia cómo se muestran servicios y el flujo de ventas.</p>
          </Card>
          ...
          <Card className={styles.seccion}>
                ...
                {horarios.map((h) => {
                  ...
                  return (
                    <div key={h.diaSemana} className={styles.horarioRow}>
                      ...
                      <div className={styles.horarioToggle}>
                        <button
                          type="button"
                          className={`${styles.horarioBtn} ${h.abierto ? styles.horarioBtnOn : ''}`}
                          onClick={() => setHorario(h.diaSemana, { ...h, abierto: true })}
                        >
                          Abierto
                        </button>
                        <button
                          type="button"
                          className={`${styles.horarioBtn} ${!h.abierto ? styles.horarioBtnOn : styles.horarioBtnOff}`}
                          onClick={() => setHorario(h.diaSemana, { ...h, abierto: false })}
                        >
                          Cerrado
                        </button>
                      </div>
            ...
            <div className={styles.horarioActions}>
              <Button
                ...
                disabled={horariosSaving || horariosLoading}
              >
                Borrar (abierto 24 h)
              </Button>
              ...
              {data.todosLosModulos.map((m) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span>{m.label}</span>
                    {fijo && <span className={styles.moduloLock}>fijo</span>}
                  </button>
                );
              })}
            </div>
        ...
        <Card className={styles.planCard}>
          ...
          <p className={styles.hint}>Descargá tus datos en archivos CSV (compatibles con Excel) para guardar respaldo o analizar fuera de la app.</p>
